...
(let ((class '((class color) (min-colors 89)))
  ...
  (let (
        ...
        (java-blue "#11C4C6")
        (royal-blue "#4078F2")
        (lochmara-blue "#0184BC")
        (tuna-grey-1 "#383A42")
        (tuna-grey-2 "#373B41")
        (slate-grey "#747D91")
        (santas-grey "#A0A1A7")
        (shuttle-grey-1 "#5A6375")
        (shuttle-grey-2 "#696C77")
        (ship-grey "#424243")
        (iron-grey-1 "#DBDBDC")
        (iron-grey-2 "#E5E5E6")
        (iron-grey-3 "#D3D4D5")
        (manatee-grey "#9D9D9F")
        (trout-metallic "#4E5666")
        (chateau-green "#3BBA54")
        (emerald-green "#4CC263")
        (fruitsalad-green "#50A14F")
        (pirate-gold "#C18401")
        (chelsea-gem-brown "#986801")
        (medium-red-violet "#A626A4")
        (mandy-red "#E45649")
        (crimson-red "#CA1243")
        (burnt-umber-red "#882328")
        (scarlet-red "#FF1414")
        (buttercup-orange "#F2A60D")
        (verdigris-olive "#606135")
        )
  (custom-theme-set-faces
   ...
   `(typescript-baby ((,class (:foreground "#FF6DAF"))))
   `(special-comment ((,class (:foreground "#FF6DAF" :background "purple" :underline t))))
   `(org-target ((,class (:foreground "#FF6DAF"))))
